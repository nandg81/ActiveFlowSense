...
Controller for ActiveFlowSense
'''
...
def _timer_func ():
	...
	for flow in active_list:
		if flow['active']==1 and current_time-prv_utilization[flow['dpid']][mac_to_port[flow['dpid']][flow['dst']]]['time']>=timer_value and current_time-flow['start_time']>=timer_value:
...
'''			
def launch():
	global timeout_value,timer_value
